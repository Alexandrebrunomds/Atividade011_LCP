...
class Player(pygame.sprite.Sprite):
    def __init__(self, pos_x, pos_y):
        ...
        # Walking animation
        self.sprites_walk.append(pygame.image.load("Assets/mario_idle.png"))
        self.sprites_walk.append(pygame.image.load("Assets/mario_walk1.png"))
        self.sprites_walk.append(pygame.image.load("Assets/mario_walk2.png"))
        self.sprites_walk.append(pygame.image.load("Assets/mario_walk3.png"))

        # Jumping animation
        self.sprites_jump = []
        self.sprites_jump.append(pygame.image.load("Assets/mario_idle.png"))
        self.sprites_jump.append(pygame.image.load("Assets/mario_jump.png"))
